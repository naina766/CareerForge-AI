...
export default function LoginPage() {
  ...
  // Quick helper to fill demo credentials during interview / review
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center p-4 sm:p-6 lg:p-8">
      <div className="max-w-5xl w-full grid grid-cols-1 lg:grid-cols-12 rounded-3xl border border-slate-800/90 glass-panel overflow-hidden shadow-2xl">
        ...
        <div className="lg:col-span-6 bg-gradient-to-br from-slate-900 via-slate-950 to-[#070b12] p-8 sm:p-12 flex flex-col justify-between border-b lg:border-b-0 lg:border-r border-slate-800/80">
          <div className="space-y-6">
            ...
            <div className="space-y-3.5 pt-2">
              <div className="flex items-center gap-3 text-xs text-slate-300">
                ...
                <span>40/25/20/10/5 Deterministic + LLM Hybrid Scoring</span>
              </div>
              <div className="flex items-center gap-3 text-xs text-slate-300">
                ...
                <span>Grounded RAG Assistant Isolated to Authenticated User</span>
              </div>
              <div className="flex items-center gap-3 text-xs text-slate-300">
                ...
                <span>Short-Lived Access JWT & Rotated Hashed Refresh Tokens</span>
              </div>
            </div>
          </div>
          ...
          <div className="pt-8 border-t border-slate-800/80 mt-8 space-y-2">
            <span className="text-[11px] font-semibold uppercase tracking-wider text-slate-500">
              Instant Demo Fill (Dev/Review):
            </span>
            <div className="flex flex-wrap gap-2 pt-1">
              <button
                type="button"
                onClick={() => handleFillDemo('alex.rivera@careerforge.ai')}
                className="text-xs px-2.5 py-1 rounded-lg bg-slate-800/80 hover:bg-slate-700 text-teal-300 border border-slate-700 transition-colors"
              >
                Candidate Demo
              </button>
              <button
                type="button"
                onClick={() => handleFillDemo('recruiter.techcorp@careerforge.ai')}
                className="text-xs px-2.5 py-1 rounded-lg bg-slate-800/80 hover:bg-slate-700 text-cyan-300 border border-slate-700 transition-colors"
              >
                Recruiter Demo
              </button>
              <button
                type="button"
                onClick={() => handleFillDemo('admin@careerforge.ai')}
                className="text-xs px-2.5 py-1 rounded-lg bg-slate-800/80 hover:bg-slate-700 text-indigo-300 border border-slate-700 transition-colors"
              >
                Admin Demo
              </button>
            </div>
        ...
        {/* Right / Form Side */}
        <div className="lg:col-span-6 p-8 sm:p-12 flex flex-col justify-center bg-slate-950/70">
